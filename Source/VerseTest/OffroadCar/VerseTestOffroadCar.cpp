...
#include "VerseTestOffroadCar.h"
#include "VerseTestOffroadWheelFront.h"
#include "VerseTestOffroadWheelRear.h"
...
AVerseTestOffroadCar::AVerseTestOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVerseTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVerseTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVerseTestOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVerseTestOffroadWheelRear::StaticClass();
