...
#include "VerseTestSportsCar.h"
#include "VerseTestSportsWheelFront.h"
#include "VerseTestSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AVerseTestSportsCar::AVerseTestSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVerseTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVerseTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVerseTestSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVerseTestSportsWheelRear::StaticClass();
